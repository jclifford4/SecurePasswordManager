...
- ***Hashed + salted*** master passwords are stored for each user. These are needed to **unlock** service passwords.
  ...
  - <a href="https://en.wikipedia.org/wiki/PBKDF2#:~:text=PBKDF2%20applies%20a%20pseudorandom%20function,cryptographic%20key%20in%20subsequent%20operations" target="_blank">PBKDF2</a>
  - <a href="https://en.wikipedia.org/wiki/HMAC" target="_blank">HMAC</a>
